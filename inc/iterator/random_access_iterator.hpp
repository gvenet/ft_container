...
class random_access_iterator : ft::Iterator<ft::random_access_iterator_tag, T> {
	public:
		...
		typedef
				typename ft::Iterator<ft::random_access_iterator_tag, T>::difference_type difference_type;
		typedef T*																																		pointer;
		typedef T&																																		reference;
	...
	public:
		friend bool operator==( const ft::random_access_iterator<T> lhs,
